...
--
-- Host: localhost
-- Gegenereerd op: 25 mrt 2020 om 10:24
...
INSERT INTO `user` (`id`, `email`, `BSN`, `firstname`, `lastname`, `gender`, `tnumber`, `banknum`, `income`, `partner`) VALUES
(1, 'thomas@ziggo.nl', 293829382, 'Thomas', 'de Groot', 'male', '0645456937', 'NL66INGB2382485834', 39843, 43);
